...
module EtsyApi
  ...
  class BuyerTaxonomyNodePropertiesResultsInner
    ...
    attr_accessor :supports_attributes

    # When true, you can use this property in listing variations.
    attr_accessor :supports_variations

    # When true, you can assign multiple property values to this property
    attr_accessor :is_multivalued

    # When true, you can assign multiple property values to this property
    attr_accessor :max_values_allowed
    ...
    def self.openapi_types
      {
        ...
        :'name' => :'String',
        :'display_name' => :'String',
        :'scales' => :'Array<BuyerTaxonomyNodePropertyScalesInner>',
        :'is_required' => :'Boolean',
        :'supports_attributes' => :'Boolean',
        :'supports_variations' => :'Boolean',
        :'is_multivalued' => :'Boolean',
        :'max_values_allowed' => :'Integer',
        :'possible_values' => :'Array<BuyerTaxonomyNodePropertyPossibleValuesInner>',
        :'selected_values' => :'Array<BuyerTaxonomyNodePropertySelectedValuesInner>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EtsyApi::BuyerTaxonomyNodePropertiesResultsInner` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EtsyApi::BuyerTaxonomyNodePropertiesResultsInner`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'supports_attributes')
        self.supports_attributes = attributes[:'supports_attributes']
      end

      if attributes.key?(:'supports_variations')
        self.supports_variations = attributes[:'supports_variations']
      end

      if attributes.key?(:'is_multivalued')
        self.is_multivalued = attributes[:'is_multivalued']
      end

      if attributes.key?(:'max_values_allowed')
        self.max_values_allowed = attributes[:'max_values_allowed']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          supports_attributes == o.supports_attributes &&
          supports_variations == o.supports_variations &&
          is_multivalued == o.is_multivalued &&
          max_values_allowed == o.max_values_allowed &&
    ...
    def hash
      [property_id, name, display_name, scales, is_required, supports_attributes, supports_variations, is_multivalued, max_values_allowed, possible_values, selected_values].hash
    end
