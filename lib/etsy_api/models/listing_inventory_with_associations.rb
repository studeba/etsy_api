...
module EtsyApi
  ...
  class ListingInventoryWithAssociations
    ...
    attr_accessor :price_on_property
    ...
    attr_accessor :quantity_on_property
    ...
    def self.openapi_types
      {
        :'products' => :'Array<ListingInventoryProductsInner>',
        :'price_on_property' => :'Array<Integer>',
        :'quantity_on_property' => :'Array<Integer>',
        :'sku_on_property' => :'Array<Integer>',
        :'listing' => :'ListingInventoryWithAssociationsListing'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EtsyApi::ListingInventoryWithAssociations` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EtsyApi::ListingInventoryWithAssociations`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'price_on_property')
        if (value = attributes[:'price_on_property']).is_a?(Array)
          self.price_on_property = value
        end
      end

      if attributes.key?(:'quantity_on_property')
        if (value = attributes[:'quantity_on_property']).is_a?(Array)
          self.quantity_on_property = value
        end
      end

      if attributes.key?(:'sku_on_property')
        if (value = attributes[:'sku_on_property']).is_a?(Array)
          self.sku_on_property = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          products == o.products &&
          price_on_property == o.price_on_property &&
          quantity_on_property == o.quantity_on_property &&
          sku_on_property == o.sku_on_property &&
          listing == o.listing
    end
    ...
    def hash
      [products, price_on_property, quantity_on_property, sku_on_property, listing].hash
    end
