...
module EtsyApi
  ...
  class ShopListingWithAssociationsUser
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EtsyApi::ShopListingWithAssociationsUser` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EtsyApi::ShopListingWithAssociationsUser`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'image_url_75x75')
        self.image_url_75x75 = attributes[:'image_url_75x75']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          image_url_75x75 == o.image_url_75x75
    end
    ...
    def hash
      [user_id, primary_email, first_name, last_name, image_url_75x75].hash
    end
