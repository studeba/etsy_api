...
module EtsyApi
  ...
  class ShopSectionsResultsInner
    ...
    attr_accessor :active_listing_count
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EtsyApi::ShopSectionsResultsInner` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EtsyApi::ShopSectionsResultsInner`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'active_listing_count')
        self.active_listing_count = attributes[:'active_listing_count']
      end
    end
    ...
    def list_invalid_properties
      ...
      if !@active_listing_count.nil? && @active_listing_count < 0
        invalid_properties.push('invalid value for "active_listing_count", must be greater than or equal to 0.')
      end
    ...
    def valid?
      ...
      return false if !@active_listing_count.nil? && @active_listing_count < 0
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] active_listing_count Value to be assigned
    def active_listing_count=(active_listing_count)
      if !active_listing_count.nil? && active_listing_count < 0
        fail ArgumentError, 'invalid value for "active_listing_count", must be greater than or equal to 0.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          rank == o.rank &&
          user_id == o.user_id &&
          active_listing_count == o.active_listing_count
    end
    ...
    def hash
      [shop_section_id, title, rank, user_id, active_listing_count].hash
    end
