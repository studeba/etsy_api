...
module EtsyApi
  ...
  class ShopReceiptRefundsInner
    ...
    attr_accessor :note_from_issuer
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EtsyApi::ShopReceiptRefundsInner` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EtsyApi::ShopReceiptRefundsInner`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'note_from_issuer')
        self.note_from_issuer = attributes[:'note_from_issuer']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          reason == o.reason &&
          note_from_issuer == o.note_from_issuer &&
          status == o.status
    end
    ...
    def hash
      [amount, created_timestamp, reason, note_from_issuer, status].hash
    end
