...
# Unit tests for EtsyApi::ShopSectionApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ShopSectionApi' do
  before do
  ...
  describe 'test an instance of ShopSectionApi' do
    it 'should create an instance of ShopSectionApi' do
      expect(@api_instance).to be_instance_of(EtsyApi::ShopSectionApi)
    end
  end

  # unit tests for create_shop_section
  ...
  # @return [ShopSection]
  describe 'create_shop_section test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for delete_shop_section
  ...
  # @param shop_id The unique positive non-zero numeric ID for an Etsy Shop.
  # @param shop_section_id The numeric ID of a section in a specific Etsy shop.
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'delete_shop_section test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_shop_section
  ...
  # @param [Hash] opts the optional parameters
  # @return [ShopSection]
  describe 'get_shop_section test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_shop_sections
  ...
  # @param [Hash] opts the optional parameters
  # @return [ShopSections]
  describe 'get_shop_sections test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for update_shop_section
  ...
  # @param [Hash] opts the optional parameters
  # @return [ShopSection]
  describe 'update_shop_section test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
