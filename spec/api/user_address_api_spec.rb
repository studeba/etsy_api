...
# Unit tests for EtsyApi::UserAddressApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'UserAddressApi' do
  before do
  ...
  describe 'test an instance of UserAddressApi' do
    it 'should create an instance of UserAddressApi' do
      expect(@api_instance).to be_instance_of(EtsyApi::UserAddressApi)
    end
  end

  # unit tests for api_application_open_api_users_addresses_delete
  ...
  # @param user_address_id The numeric ID of the user&#39;s address.
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'api_application_open_api_users_addresses_delete test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_user_address
  ...
  # @param [Hash] opts the optional parameters
  # @return [UserAddress]
  describe 'get_user_address test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_user_addresses
  ...
  describe 'get_user_addresses test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
