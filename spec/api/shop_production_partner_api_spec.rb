...
# Unit tests for EtsyApi::ShopProductionPartnerApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ShopProductionPartnerApi' do
  before do
  ...
  describe 'test an instance of ShopProductionPartnerApi' do
    it 'should create an instance of ShopProductionPartnerApi' do
      expect(@api_instance).to be_instance_of(EtsyApi::ShopProductionPartnerApi)
    end
  end

  # unit tests for get_shop_production_partners
  ...
  describe 'get_shop_production_partners test' do
    it 'should work' do
