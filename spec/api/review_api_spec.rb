...
# Unit tests for EtsyApi::ReviewApi
...
describe 'ReviewApi' do
  ...
  describe 'test an instance of ReviewApi' do
    it 'should create an instance of ReviewApi' do
      expect(@api_instance).to be_instance_of(EtsyApi::ReviewApi)
    end
  end

  # unit tests for get_reviews_by_listing
  ...
  describe 'get_reviews_by_listing test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_reviews_by_shop
  ...
  describe 'get_reviews_by_shop test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
