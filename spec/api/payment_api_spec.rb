...
# Unit tests for EtsyApi::PaymentApi
...
describe 'PaymentApi' do
  ...
  describe 'test an instance of PaymentApi' do
    it 'should create an instance of PaymentApi' do
      expect(@api_instance).to be_instance_of(EtsyApi::PaymentApi)
    end
  end

  # unit tests for get_payment_account_ledger_entry_payments
  ...
  # @param ledger_entry_ids 
  # @param [Hash] opts the optional parameters
  # @return [Payments]
  describe 'get_payment_account_ledger_entry_payments test' do
    it 'should work' do
  ...
  # @param shop_id The unique positive non-zero numeric ID for an Etsy Shop.
  # @param payment_ids A comma-separated array of Payment IDs numbers.
  # @param [Hash] opts the optional parameters
  # @return [Payments]
  ...
  # unit tests for get_shop_payment_by_receipt_id
  ...
  # @param [Hash] opts the optional parameters
  # @return [Payments]
  describe 'get_shop_payment_by_receipt_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
